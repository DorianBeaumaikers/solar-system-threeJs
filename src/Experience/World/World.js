...
export default class World {
    constructor() {
        ...
        this.resources.on('ready', () => {
            ...
            this.venus = new Planet("venus", 4.87, 0.6052, 5243, 8.9, 5832.4, 10750, 10890, 10820, 10799.74, 75.6, 224.7, 0.035, 0.007, 3.4, 177.4, 6.52, 2.2, this.resources.items.venusTexture, "Venus spins slowly in the opposite direction from most planets. A thick atmosphere traps heat in a runaway greenhouse effect, making it the hottest planet in our solar system.");
            this.planets.push(this.venus);
            this.earth = new Planet("earth", 5.97, 0.6378, 5514, 9.8, 24, 14710, 15210, 14960, 14997.83, 255, 365.2, 0.0298, 0.017, 0, 23.4, 1574, 2.4, this.resources.items.earthTexture, "Earth - our home planet - is the only place we know of so far that’s inhabited by living things. It's also the only planet in our solar system with liquid water on the surface.");
            this.planets.push(this.earth);
            this.mars = new Planet("mars", 0.642, 0.3396, 3934, 3.7, 24.7, 20670, 24930, 22800, 22699.05, 2143.2, 687, 0.0241, 0.094, 1.8, 25.2, 866, 1.3, this.resources.items.marsTexture, "Mars is a dusty, cold, desert world with a very thin atmosphere. There is strong evidence Mars was—billions of years ago—wetter and warmer, with a thicker atmosphere.");
            this.planets.push(this.mars);
            this.jupiter = new Planet("jupiter", 1898, 7.1492, 1326, 23.1, 9.9, 74060, 81640, 77850, 77806.43, 3817.1, 4331, 0.0131, 0.049, 1.3, 3.1, 45583, 30, this.resources.items.jupiterTexture, "Jupiter is more than twice as massive than the other planets of our solar system combined. The giant planet's Great Red spot is a centuries-old storm bigger than Earth.");
            this.planets.push(this.jupiter);
            this.saturn = new Planet("saturn", 568, 6.0268, 687, 9, 10.7, 135760, 150650, 143200, 148811.49, 8151, 10747, 0.0097, 0.052, 2.5, 26.7, 36840, 25, this.resources.items.saturnTexture, "Adorned with a dazzling, complex system of icy rings, Saturn is unique in our solar system. The other giant planets have rings, but none are as spectacular as Saturn's.");
            this.planets.push(this.saturn);
            this.uranus = new Planet("uranus", 86.8, 2.5559, 1270, 8.7, 17.2, 273270, 300140, 286700, 286696.19, 13202, 30589, 0.0068, 0.047, 0.8, 97.8, 14794, 11, this.resources.items.uranusTexture, "Uranus - seventh planet from the Sun - rotates at a nearly 90-degree angle from the plane of its orbit. This unique tilt makes Uranus appear to spin on its side.");
